...
import com.mgc.terminal.Service.TouyingService;
import com.mgc.terminal.bean.BtnBean;
import java.util.List;

public class TouyingAdapter extends BaseAdapter {
    private LayoutInflater mInflater = null;
    private Context mContext;
    private List<BtnBean> mArrayList = null;

    public TouyingAdapter(Context context, List<BtnBean> arrayList) {
        mContext = context;
...
//            //holder.imageView.setScaleType(ImageView.ScaleType.FIT_CENTER);
            ...
            holder.start.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Toast.makeText(mContext,"打开投影",Toast.LENGTH_SHORT).show();
                    TouyingService c=new TouyingService();
                    c.TouyingControl(mBean.getIP(),"on");
            ...
            holder.shutdown.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Toast.makeText(mContext,"关闭投影",Toast.LENGTH_SHORT).show();
                    TouyingService c=new TouyingService();
                    c.TouyingControl(mBean.getIP(),"off");
